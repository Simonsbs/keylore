...
`v1.0.0-rc1` froze the current public contract. `v1.0.0-rc2` added the operator UI on top of that surface, `v1.0.0-rc3` tightened release verification, and `v1.0.0-rc4` standardizes the final rehearsal without changing the underlying REST, OAuth, or MCP compatibility guarantees.
